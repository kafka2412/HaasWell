...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=HaasWell Demo Installer\n"
      else:
        line="OutputBaseFilename=HaasWell Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the HaasWell Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the HaasWell installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=HaasWell Demo installer\n"
     else:
       line="SetupWindowTitle=HaasWell installer\n"
